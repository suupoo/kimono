            ...
            <x-list.search-box>
                @foreach($model::getColumns() as $column)
                    ...
                    @if(in_array($column->column(), $arraySearchable))
                        ...
                        @if($column instanceof \App\ValueObjects\Column\User\OwnerSequenceNo)
                        ...
                        @if($column instanceof \App\ValueObjects\Column\User\EmailVerifiedAt)
                            {!! $column->input(['class' => ''])!!}
                        @endif
            ...
            <x-table.table>
                @slot('tHead')
                    <tr>
                        ...
                        @foreach($model::getColumns() as $column)
                            @php
                                if ($column instanceof \App\ValueObjects\Column\User\Id) continue;
                                elseif ($column instanceof \App\ValueObjects\Column\User\OwnerSystemCompany) continue;
                                elseif ($column instanceof \App\ValueObjects\Column\User\DeletedAt) continue;
                            @endphp
