            ...
            <x-table.table>
                @slot('tHead')
                    <tr>
                        ...
                        @foreach($model::getColumns() as $column)
                            @php
                                if ($column instanceof \App\ValueObjects\Column\Attendance\Id) continue;
                                elseif ($column instanceof \App\ValueObjects\Column\Attendance\OwnerSystemCompany) continue;
                                elseif ($column instanceof \App\ValueObjects\Column\Attendance\DeletedAt) continue;
                            @endphp
