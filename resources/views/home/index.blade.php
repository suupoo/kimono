...
@section('content')
    ...
    <div class="flex w-full flex flex-col">
        <div class="flex flex-row w-full gap-1">
            <div class="custom-dashboard-item w-1/3 flex flex-col justify-center items-center">
            ...
            <div class="custom-dashboard-item text-sm gap-1 w-2/3 flex flex-col items-end">
